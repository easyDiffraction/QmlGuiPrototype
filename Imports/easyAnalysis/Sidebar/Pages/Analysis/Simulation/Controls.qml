    ...
    GenericElements.GroupBox {
        ...
        content: GenericElements.ColumnLayout {
            ...
            GenericElements.ParametersTable {
                ...
                Controls1.TableViewColumn { title:"Remove"; resizable: false; delegate: GenericContentAreaButtons.Remove {} }
            }
        }
    }
    ...
    GenericElements.GroupBox {
        ...
        content: GenericElements.ColumnLayout {
            ...
            GenericElements.ParametersTable {
                ...
                //Controls1.TableViewColumn { role:"fit";         title:"Fit"; resizable: false; visible: isFitting; delegate: GenericElements.CheckBox { checked: styleData.value } }
            ...
            // Buttons
            GenericElements.RowLayout {
                GenericContentAreaButtons.Import { id: importButton;  text: "Run/Update simulation"; }
