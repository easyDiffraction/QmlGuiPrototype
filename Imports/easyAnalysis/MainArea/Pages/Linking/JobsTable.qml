...
Rectangle {
    ...
    GenericElements.ParametersTable {
        ...
        Controls1.TableViewColumn { role:"jobIndex"; title:"No."; resizable: false; delegate: GenericElements.CellComboBox { currentIndex: styleData.value;
                model: ["1", "2", "3"] } }

        Controls1.TableViewColumn { role:"jobName"; title:"Job Name" }

        Controls1.TableViewColumn { role:"dataIndex"; title:"Experimental Data"; delegate: GenericElements.CellComboBox { currentIndex: styleData.value;
        ...
        Controls1.TableViewColumn { role:"sampleIndex"; title:"Sample Model"; delegate: GenericElements.CellComboBox { currentIndex: styleData.value;
                model: ["CeCuAl3", "Al"] } }

        Controls1.TableViewColumn { role:"instrumentIndex"; title:"Instrument Model"; delegate: GenericElements.CellComboBox { currentIndex: styleData.value;
                model: ["POLARIS", "DREAM"] } }
