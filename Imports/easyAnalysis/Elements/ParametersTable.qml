        ...
        RowLayout {
            ...
            Image {
                ...
                function iconSelector() {
                    ...
                    if (styleData.value === "Remove") return "../Icons/TrashCan.svg"
                    return ""
                }
                ColorOverlay {
        ...
        RowLayout {
            ...
            Image {
                ...
                function iconSelector() {
                    ...
                    if (styleData.value === "sample") return "../Icons/Diamond.svg"
                    if (styleData.value === "instrument") return "../Icons/Microscope.svg"
                    return ""
                }
                ColorOverlay {
                    source: icon
            ...
            GenericContentArea.Button {
                ...
                function iconSelector() {
                    if (styleData.role === "remove") return "../Icons/Minus.svg"
                    return ""
                }
            }
