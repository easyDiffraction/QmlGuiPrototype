...
import easyAnalysis.App.ContentArea.MainArea.Pages 1.0 as GenericMainAreaPages
...
ColumnLayout {
    ...
    Rectangle {
        ...
        Text { id: dam;         text: " data analysis and modelling ";   x: making.width + diffraction.width; font.family: Generic.Style.titleThinFontFamily; font.pointSize: 32; color: "#666" }
